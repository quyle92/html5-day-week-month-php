	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input class="form-control" type="text" required placeholder="Họ Tên*" value="nam" name="name">
			</div>
		</div>
	</div>
	<div class="row">
<!-- 		<div class="col-md-6">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input class="form-control" type="text" required placeholder="Nhân Viên*" value="mai" name="staff">
			</div>
		</div>
	</div>
...
<!-- 		<div class="col-md-6">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input class="form-control" type="text" required placeholder="Service*" value="spa" name="service">
			</div>
		</div>
	</div>
...
<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<input class="form-control" type="text" required placeholder="start" id="start" name="start">
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				<input class="form-control" type="text" required placeholder="end" id="end" name="end">
			</div>
		</div>
